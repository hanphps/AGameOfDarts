...
public class StartMenu extends javax.swing.JFrame {
    ...
    protected ScorePanel p;
    protected DartsGame g;
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Use the mouse to move the dart.\nHold the left click button to increase\npower.   \nRelease to hit the target.\nPress R to reload dart. \nClick Backspace to return to main \nmenu.");
        ...
        jLabel2.setText("A Game Of Darts");
    ...
    private void NewGame(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NewGame
        g = new DartsGame(jTextField1.getText());
        g.b.setMulti(jSlider1.getValue());
        //this.dispose();
    ...
    private void jSlider1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSlider1StateChanged
        //g.b.setMulti((int) Math.floor(jSlider1.getValue()));
